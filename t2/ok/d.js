...
// Global browser instance (optional - can be reused)
let globalBrowser = null;

// Function to open Facebook.com and handle login
...
server.listen(PORT, async () => {
  ...
  // Automatically open Facebook.com when server starts
  console.log('\n🌐 Opening Facebook.com automatically on server start...');
  try {
    await openFacebook();
    console.log('✅ Facebook.com is ready!');
  } catch (error) {
    console.error('⚠️  Failed to open Facebook.com automatically:', error.message);
    console.log('💡 You can manually open it by calling GET /open-facebook');
  }
});
